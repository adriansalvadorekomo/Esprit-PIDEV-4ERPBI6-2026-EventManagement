...
package automatization.sacategory_0_1;
...
/**
 * Job: SAcategory Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SAcategory implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SAcategory";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAcategory.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AUTOMATIZATION_SAcategory = new byte[0];
    static byte[] commonByteArray_AUTOMATIZATION_SAcategory = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUTOMATIZATION_SAcategory.length) {
				if(length < 1024 && commonByteArray_AUTOMATIZATION_SAcategory.length == 0) {
   					commonByteArray_AUTOMATIZATION_SAcategory = new byte[1024];
				} else {
   					commonByteArray_AUTOMATIZATION_SAcategory = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUTOMATIZATION_SAcategory, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAcategory, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUTOMATIZATION_SAcategory, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAcategory, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUTOMATIZATION_SAcategory) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("category_sa");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("category_sa");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:GOyi70JCItL+dAwz0ioYsWHmTwjOwkodJqVmVE8NwTc=");
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_category\",\"category_name\") VALUES (?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:T/wtJ484j0NorxFJQ+B+h/Q0C00zBMyHhoDThA==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "CATEGORY", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "category_name";

				row1.category_name = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
...
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
                    ...
                    if(row1.category_name == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row1.category_name);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SAcategory SAcategoryClass = new SAcategory();

        int exitCode = SAcategoryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAcategory.class.getClassLoader().getResourceAsStream("automatization/sacategory_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAcategory.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAcategory");
        }
...
/************************************************************************************************
 *     57240 characters generated by Talend Open Studio for Data Integration 
