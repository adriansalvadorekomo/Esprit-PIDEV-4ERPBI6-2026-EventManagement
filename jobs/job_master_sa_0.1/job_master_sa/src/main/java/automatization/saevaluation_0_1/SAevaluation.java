...
package automatization.saevaluation_0_1;
...
/**
 * Job: SAevaluation Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SAevaluation implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SAevaluation";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAevaluation.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AUTOMATIZATION_SAevaluation = new byte[0];
    static byte[] commonByteArray_AUTOMATIZATION_SAevaluation = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUTOMATIZATION_SAevaluation.length) {
				if(length < 1024 && commonByteArray_AUTOMATIZATION_SAevaluation.length == 0) {
   					commonByteArray_AUTOMATIZATION_SAevaluation = new byte[1024];
				} else {
   					commonByteArray_AUTOMATIZATION_SAevaluation = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUTOMATIZATION_SAevaluation, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAevaluation, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUTOMATIZATION_SAevaluation, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAevaluation, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUTOMATIZATION_SAevaluation) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("evaluation_sa");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("evaluation_sa");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:CyyKKFniqAHK5x79ttTQI+bMN2M4+eZo0j9vXjPyml8=");
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_evaluation\",\"id_reservation\",\"rating\",\"comment\") VALUES (?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:rVHDnk03aGue9fxw09HRnvLAFMBRt2iOdBzqLQ==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "EVALUATION", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "id_evaluation";

				row1.id_evaluation = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.id_reservation = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.rating = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.rating = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "comment";

				row1.comment = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.comment = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row1.id_evaluation == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row1.id_evaluation);
}

                    if(row1.id_reservation == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row1.id_reservation);
}

                    if(row1.rating == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row1.rating);
}

                    if(row1.comment == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row1.comment);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SAevaluation SAevaluationClass = new SAevaluation();

        int exitCode = SAevaluationClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAevaluation.class.getClassLoader().getResourceAsStream("automatization/saevaluation_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAevaluation.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAevaluation");
        }
...
/************************************************************************************************
 *     59320 characters generated by Talend Open Studio for Data Integration 
