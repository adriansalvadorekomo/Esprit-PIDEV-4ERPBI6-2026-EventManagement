...
package automatization.saprovider_0_1;
...
/**
 * Job: SAprovider Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SAprovider implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SAprovider";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAprovider.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AUTOMATIZATION_SAprovider = new byte[0];
    static byte[] commonByteArray_AUTOMATIZATION_SAprovider = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUTOMATIZATION_SAprovider.length) {
				if(length < 1024 && commonByteArray_AUTOMATIZATION_SAprovider.length == 0) {
   					commonByteArray_AUTOMATIZATION_SAprovider = new byte[1024];
				} else {
   					commonByteArray_AUTOMATIZATION_SAprovider = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUTOMATIZATION_SAprovider, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAprovider, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUTOMATIZATION_SAprovider, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAprovider, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUTOMATIZATION_SAprovider) {
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("provider_sa");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("provider_sa");
}
...
String dbUser_tDBOutput_2 = null;
    ...
    java.lang.Class.forName("org.postgresql.Driver");
        ...
        String url_tDBOutput_2 = "jdbc:postgresql://"+"host.docker.internal"+":"+"5432"+"/"+"SA_event";
    dbUser_tDBOutput_2 = "postgres";
 
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:It44Snspy4tKbV523MpLURf5YE5mFqiH497488Lb0P4=");
...
int count_tDBOutput_2=0;
	    ...
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"id_provider\",\"name\",\"service_type\",\"email\",\"phone\",\"city\") VALUES (?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:8TqwYJ0L5T7ZtZT6laUgphEjRxfR4WfC3D2Zdw==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "PROVIDER", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "service_type";

				row1.service_type = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "phone";

				row1.phone = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.phone = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
} else {pstmt_tDBOutput_2.setString(1, row1.id_provider);
}

                    if(row1.name == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, row1.name);
}

                    if(row1.service_type == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, row1.service_type);
}

                    if(row1.email == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, row1.email);
}

                    if(row1.phone == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, row1.phone);
}

                    if(row1.city == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, row1.city);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SAprovider SAproviderClass = new SAprovider();

        int exitCode = SAproviderClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAprovider.class.getClassLoader().getResourceAsStream("automatization/saprovider_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAprovider.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAprovider");
        }
...
/************************************************************************************************
 *     61043 characters generated by Talend Open Studio for Data Integration 
