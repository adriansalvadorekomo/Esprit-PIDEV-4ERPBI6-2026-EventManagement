...
package automatization.sabeneficiary_0_1;
...
/**
 * Job: SAbeneficiary Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SAbeneficiary implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SAbeneficiary";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SAbeneficiary.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAbeneficiary.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AUTOMATIZATION_SAbeneficiary = new byte[0];
    static byte[] commonByteArray_AUTOMATIZATION_SAbeneficiary = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUTOMATIZATION_SAbeneficiary.length) {
				if(length < 1024 && commonByteArray_AUTOMATIZATION_SAbeneficiary.length == 0) {
   					commonByteArray_AUTOMATIZATION_SAbeneficiary = new byte[1024];
				} else {
   					commonByteArray_AUTOMATIZATION_SAbeneficiary = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUTOMATIZATION_SAbeneficiary, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAbeneficiary, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUTOMATIZATION_SAbeneficiary, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAbeneficiary, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUTOMATIZATION_SAbeneficiary) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("beneficiary_sa");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("beneficiary_sa");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:AtyZm8FStLWG9/cGAnJDt916lpIHbHgXcAROcZv6Auk=");
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_beneficiary\",\"first_name\",\"last_name\",\"email\",\"phone\") VALUES (?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5IaQXdWcYZ+O1RuKQ0q4WWwVvVtjD4m0ODREMQ==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "BENEFICIARY", false));
...
} else {pstmt_tDBOutput_1.setString(1, row1.id_beneficiary);
}

                    if(row1.first_name == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row1.first_name);
}

                    if(row1.last_name == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row1.last_name);
}

                    if(row1.email == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row1.email);
}

                    if(row1.phone == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row1.phone);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SAbeneficiary SAbeneficiaryClass = new SAbeneficiary();

        int exitCode = SAbeneficiaryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAbeneficiary.class.getClassLoader().getResourceAsStream("automatization/sabeneficiary_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAbeneficiary.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAbeneficiary");
        }
...
/************************************************************************************************
 *     60285 characters generated by Talend Open Studio for Data Integration 
 *     on the April 20, 2026 at 11:54:05 PM WAT
 ************************************************************************************************/
