...
package automatization.saevent_0_1;
...
/**
 * Job: SAevent Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SAevent implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SAevent";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAevent.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AUTOMATIZATION_SAevent = new byte[0];
    static byte[] commonByteArray_AUTOMATIZATION_SAevent = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUTOMATIZATION_SAevent.length) {
				if(length < 1024 && commonByteArray_AUTOMATIZATION_SAevent.length == 0) {
   					commonByteArray_AUTOMATIZATION_SAevent = new byte[1024];
				} else {
   					commonByteArray_AUTOMATIZATION_SAevent = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUTOMATIZATION_SAevent, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAevent, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUTOMATIZATION_SAevent, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAevent, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUTOMATIZATION_SAevent) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("event_sa");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("event_sa");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:oI9jZKhJ17Ty2ND+v8YdT6Vu/kZFbH1hvoCp7EQAgIE=");
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_event\",\"title\",\"event_date\",\"budget\",\"type\",\"id_beneficiary\") VALUES (?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:kcmhTA9V7TE8S6XB0Pu6fnJfQSbvY8aNaEs7Rg==");
		...
		Object source_tFileInputExcel_5 = "/opt/talend/data/eventzella_schema_general-DW.xlsx";
        ...
        sheetList_tFileInputExcel_5.addAll(regexUtil_tFileInputExcel_5.getSheets(workbook_tFileInputExcel_5, "EVENT", false));
	...
	if(sheetList_tFileInputExcel_5.size()>0){
        ...
        for(int i_tFileInputExcel_5 = begin_line_tFileInputExcel_5; i_tFileInputExcel_5 < end_line_tFileInputExcel_5; i_tFileInputExcel_5++){
		    ...
		    row1 = null;
					int tempRowLength_tFileInputExcel_5 = 6;
			...
			if( temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
				...
				curColName_tFileInputExcel_5 = "id_event";

				row1.id_event = temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5];
			}else{
				row1.id_event = null;
			...
			if( temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
				curColNum_tFileInputExcel_5=columnIndex_tFileInputExcel_5 + start_column_tFileInputExcel_5 + 1;
				curColName_tFileInputExcel_5 = "title";

				row1.title = temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5];
			}else{
				row1.title = null;
				emptyColumnCount_tFileInputExcel_5++;
			}
			...
			if( temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
				curColNum_tFileInputExcel_5=columnIndex_tFileInputExcel_5 + start_column_tFileInputExcel_5 + 1;
				curColName_tFileInputExcel_5 = "event_date";

				row1.event_date = temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5];
			}else{
			...
			if( temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
				curColNum_tFileInputExcel_5=columnIndex_tFileInputExcel_5 + start_column_tFileInputExcel_5 + 1;
				curColName_tFileInputExcel_5 = "budget";

				row1.budget = temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5];
			}else{
				row1.budget = null;
				emptyColumnCount_tFileInputExcel_5++;
			}
			...
			if( temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
				curColNum_tFileInputExcel_5=columnIndex_tFileInputExcel_5 + start_column_tFileInputExcel_5 + 1;
				curColName_tFileInputExcel_5 = "type";

				row1.type = temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5];
			}else{
				row1.type = null;
				emptyColumnCount_tFileInputExcel_5++;
			}
			...
			if( temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
				curColNum_tFileInputExcel_5=columnIndex_tFileInputExcel_5 + start_column_tFileInputExcel_5 + 1;
				curColName_tFileInputExcel_5 = "id_beneficiary";

				row1.id_beneficiary = temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5];
			}else{
...
if(row1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row1.id_event == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row1.id_event);
}

                    if(row1.title == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row1.title);
}

                    if(row1.event_date == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row1.event_date);
}

                    if(row1.budget == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row1.budget);
}

                    if(row1.type == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row1.type);
}

                    if(row1.id_beneficiary == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, row1.id_beneficiary);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SAevent SAeventClass = new SAevent();

        int exitCode = SAeventClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAevent.class.getClassLoader().getResourceAsStream("automatization/saevent_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAevent.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
try {
errorCode = null;tFileInputExcel_5Process(globalMap);
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAevent");
        }
...
/************************************************************************************************
 *     61034 characters generated by Talend Open Studio for Data Integration 
 *     on the April 20, 2026 at 11:54:07 PM WAT
 ************************************************************************************************/
