...
package automatization.saservice_0_1;
...
/**
 * Job: SAservice Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SAservice implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SAservice";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAservice.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AUTOMATIZATION_SAservice = new byte[0];
    static byte[] commonByteArray_AUTOMATIZATION_SAservice = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUTOMATIZATION_SAservice.length) {
				if(length < 1024 && commonByteArray_AUTOMATIZATION_SAservice.length == 0) {
   					commonByteArray_AUTOMATIZATION_SAservice = new byte[1024];
				} else {
   					commonByteArray_AUTOMATIZATION_SAservice = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUTOMATIZATION_SAservice, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAservice, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUTOMATIZATION_SAservice, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAservice, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUTOMATIZATION_SAservice) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("service_sa");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("service_sa");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:AgsM+/VqRMVKLEgP0U+czDPRX7IefGwUC4QUySpgiA0=");
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_service\",\"price\",\"description\",\"id_provider\",\"id_subcategory\",\"title\") VALUES (?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:X4kw85u6iz5ItgtidPXwBk9RDigzS65aE+jFzA==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "SERVICE", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.id_service = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.price = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.price = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "id_subcategory";

				row1.id_subcategory = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
...
} else {pstmt_tDBOutput_1.setString(1, row1.id_service);
}

                    if(row1.price == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row1.price);
}

                    if(row1.description == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row1.description);
}

                    if(row1.id_provider == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row1.id_provider);
}

                    if(row1.id_subcategory == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row1.id_subcategory);
}

                    if(row1.title == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, row1.title);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SAservice SAserviceClass = new SAservice();

        int exitCode = SAserviceClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAservice.class.getClassLoader().getResourceAsStream("automatization/saservice_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAservice.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAservice");
        }
...
/************************************************************************************************
 *     61235 characters generated by Talend Open Studio for Data Integration 
 *     on the April 20, 2026 at 11:54:09 PM WAT
 ************************************************************************************************/
