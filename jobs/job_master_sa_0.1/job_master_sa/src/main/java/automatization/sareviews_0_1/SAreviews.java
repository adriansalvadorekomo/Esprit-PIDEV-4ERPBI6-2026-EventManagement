...
package automatization.sareviews_0_1;
...
/**
 * Job: SAreviews Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SAreviews implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SAreviews";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAreviews.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AUTOMATIZATION_SAreviews = new byte[0];
    static byte[] commonByteArray_AUTOMATIZATION_SAreviews = new byte[0];
				...
				public String getBK_COMMENT () {
					return this.BK_COMMENT;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUTOMATIZATION_SAreviews.length) {
				if(length < 1024 && commonByteArray_AUTOMATIZATION_SAreviews.length == 0) {
   					commonByteArray_AUTOMATIZATION_SAreviews = new byte[1024];
				} else {
   					commonByteArray_AUTOMATIZATION_SAreviews = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUTOMATIZATION_SAreviews, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAreviews, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUTOMATIZATION_SAreviews, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAreviews, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUTOMATIZATION_SAreviews) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.BK_COMMENT = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.BK_COMMENT,dos);
    ...
    public String toString() {
		...
		sb.append(",BK_COMMENT="+BK_COMMENT);
	    sb.append("]");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("reviews_sa");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("reviews_sa");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:zQPjDF9kzyUFdy7n03i4jI371U9qUWYrwXfcyqkmXyc=");
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"User\",\"Title\",\"Rating\",\"Description\",\"BK_COMMENT\") VALUES (?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:/BUodZXWgPKI2GDDbFRqsXbe9QzeOnxHYC88cg==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "reviews", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "User";

				row1.User = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.User = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "BK_COMMENT";

				row1.BK_COMMENT = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.BK_COMMENT = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
} else {pstmt_tDBOutput_1.setString(1, row1.User);
}
...
} else {pstmt_tDBOutput_1.setString(4, row1.Description);
}

                    if(row1.BK_COMMENT == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row1.BK_COMMENT);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SAreviews SAreviewsClass = new SAreviews();

        int exitCode = SAreviewsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAreviews.class.getClassLoader().getResourceAsStream("automatization/sareviews_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAreviews.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAreviews");
        }
...
/************************************************************************************************
 *     60048 characters generated by Talend Open Studio for Data Integration 
