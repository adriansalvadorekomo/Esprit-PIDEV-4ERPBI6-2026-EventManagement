...
package automatization.sa_category_service_0_1;
...
/**
 * Job: SA_category_service Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SA_category_service implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SA_category_service";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SA_category_service.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SA_category_service.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AUTOMATIZATION_SA_category_service = new byte[0];
    static byte[] commonByteArray_AUTOMATIZATION_SA_category_service = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUTOMATIZATION_SA_category_service.length) {
				if(length < 1024 && commonByteArray_AUTOMATIZATION_SA_category_service.length == 0) {
   					commonByteArray_AUTOMATIZATION_SA_category_service = new byte[1024];
				} else {
   					commonByteArray_AUTOMATIZATION_SA_category_service = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUTOMATIZATION_SA_category_service, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SA_category_service, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUTOMATIZATION_SA_category_service, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SA_category_service, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUTOMATIZATION_SA_category_service) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("sa_category_service");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("sa_category_service");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:a44ieyVs/+3VCJcE7sm7hwRXshFI7/JFhA0C//iTQWA=");
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_category\",\"id_subcategory\") VALUES (?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:6MmdodxbAuTgCubFD50yMLwvQOz/BkCgqulyag==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "CATEGORY_SERVICE", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "id_category";

				row1.id_category = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
...
} else {pstmt_tDBOutput_1.setString(1, row1.id_category);
}

                    if(row1.id_subcategory == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row1.id_subcategory);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SA_category_service SA_category_serviceClass = new SA_category_service();

        int exitCode = SA_category_serviceClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SA_category_service.class.getClassLoader().getResourceAsStream("automatization/sa_category_service_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SA_category_service.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SA_category_service");
        }
...
/************************************************************************************************
 *     57548 characters generated by Talend Open Studio for Data Integration 
 *     on the April 20, 2026 at 11:54:03 PM WAT
 ************************************************************************************************/
