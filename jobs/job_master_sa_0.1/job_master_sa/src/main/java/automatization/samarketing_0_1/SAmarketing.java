...
package automatization.samarketing_0_1;
...
/**
 * Job: SAmarketing Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SAmarketing implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SAmarketing";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAmarketing.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_AUTOMATIZATION_SAmarketing = new byte[0];
    static byte[] commonByteArray_AUTOMATIZATION_SAmarketing = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUTOMATIZATION_SAmarketing.length) {
				if(length < 1024 && commonByteArray_AUTOMATIZATION_SAmarketing.length == 0) {
   					commonByteArray_AUTOMATIZATION_SAmarketing = new byte[1024];
				} else {
   					commonByteArray_AUTOMATIZATION_SAmarketing = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUTOMATIZATION_SAmarketing, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAmarketing, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUTOMATIZATION_SAmarketing, 0, length);
			strReturn = new String(commonByteArray_AUTOMATIZATION_SAmarketing, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUTOMATIZATION_SAmarketing) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("marketing_spend_sa");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("marketing_spend_sa");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:XjSdn6cIXab9cMJCtBdME1dp5M+5bhucp+TOj3zVZTU=");
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id\",\"month\",\"marketing_spend\",\"new_beneficiaries\") VALUES (?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:UFHj9wZUQ6rqESvwRtjbAh//pKJcQaEs4kxrCQ==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "MARKETING_SPEND", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row10.id = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row10.id = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row10.month = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row10.month = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "marketing_spend";

				row10.marketing_spend = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row10.marketing_spend = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "new_beneficiaries";

				row10.new_beneficiaries = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row10.new_beneficiaries = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
} else {pstmt_tDBOutput_1.setString(1, row10.id);
}

                    if(row10.month == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row10.month);
}

                    if(row10.marketing_spend == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row10.marketing_spend);
}

                    if(row10.new_beneficiaries == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row10.new_beneficiaries);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SAmarketing SAmarketingClass = new SAmarketing();

        int exitCode = SAmarketingClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAmarketing.class.getClassLoader().getResourceAsStream("automatization/samarketing_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAmarketing.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAmarketing");
        }
...
/************************************************************************************************
 *     59322 characters generated by Talend Open Studio for Data Integration 
