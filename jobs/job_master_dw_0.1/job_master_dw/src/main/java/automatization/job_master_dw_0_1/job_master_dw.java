...
package automatization.job_master_dw_0_1;
...
/**
 * Job: job_master_dw Purpose: dw master<br>
 * Description: job master for dw <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class job_master_dw implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_master_dw";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_master_dw.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_master_dw.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		automatization.benficiary_dwh_0_1.benficiary_DWH childJob_tRunJob_1 = new automatization.benficiary_dwh_0_1.benficiary_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		automatization.category_dw_1_0_1.category_dw_1 childJob_tRunJob_2 = new automatization.category_dw_1_0_1.category_dw_1();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		automatization.dim_competitors_0_1.dim_competitors childJob_tRunJob_3 = new automatization.dim_competitors_0_1.dim_competitors();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		automatization.dim_complaints_0_1.dim_complaints childJob_tRunJob_4 = new automatization.dim_complaints_0_1.dim_complaints();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		automatization.dim_date_0_1.DIM_date childJob_tRunJob_5 = new automatization.dim_date_0_1.DIM_date();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		automatization.dim_events_0_1.dim_events childJob_tRunJob_6 = new automatization.dim_events_0_1.dim_events();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		automatization.dim_locations_0_1.DIM_locations childJob_tRunJob_7 = new automatization.dim_locations_0_1.DIM_locations();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		automatization.dim_reservation_0_1.dim_reservation childJob_tRunJob_8 = new automatization.dim_reservation_0_1.dim_reservation();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		automatization.dim_reviews_0_1.dim_reviews childJob_tRunJob_9 = new automatization.dim_reviews_0_1.dim_reviews();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		automatization.evaluation_dwh_0_1.evaluation_DWH childJob_tRunJob_10 = new automatization.evaluation_dwh_0_1.evaluation_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_11 = null;
		...
		automatization.saison_dwh_0_1.saison_DWH childJob_tRunJob_11 = new automatization.saison_dwh_0_1.saison_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_12 = null;
		...
		automatization.service_dw_0_1.service_dw childJob_tRunJob_12 = new automatization.service_dw_0_1.service_dw();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_13 = null;
		...
		automatization.fact_v3_0_1.fact_v3 childJob_tRunJob_13 = new automatization.fact_v3_0_1.fact_v3();
	    // pass DataSources
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_1";
		...
		int tos_count_tDBConnection_1 = 0;
            ...
            String url_tDBConnection_1 = "jdbc:postgresql://"+"localhost"+":"+"5432"+"/"+"DW_event";
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4ihEEjaDFpVGosONeX7K0fiSRSDJlKrSpOVk3cnE6Ic=");
...
globalMap.put("tDBConnection_1_ERROR_MESSAGE",e_tDBConnection_1.getMessage());
			...
			String sharedConnectionName_tDBConnection_1 = "db_dw_job";
 ...
 */
    ...
    public static void main(String[] args){
        final job_master_dw job_master_dwClass = new job_master_dw();

        int exitCode = job_master_dwClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_master_dw.class.getClassLoader().getResourceAsStream("automatization/job_master_dw_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_master_dw.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_master_dw");
        }
...
/************************************************************************************************
 *     132211 characters generated by Talend Open Studio for Data Integration 
